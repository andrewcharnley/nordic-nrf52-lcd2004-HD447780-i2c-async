...
// 1.3KHz is about fastest speed for transfering and actioning a command or data
#define LCD_TICKS_BETWEEN_DATA 10000
#define LCD_PAYLOAD_CMD_DATA 4
...
#define LCD_BUFFER_LENGTH (1024) // should be long enough to do lots of writes and set cursor positions
